#!/usr/bin/env python3
"""Load the energy PDDL problem into PlanSys2 and request a plan."""
...
def main():
    ...
    domain_path = base_path / "pddl" / "robot_domain_energy.pddl"
    problem_path = base_path / "pddl" / "robot_problem_energy.pddl"
