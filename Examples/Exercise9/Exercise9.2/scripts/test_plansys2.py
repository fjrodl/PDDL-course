#!/usr/bin/env python3
"""Integration tests for Exercise 9.2 using PlanSys2.

Launches PlanSys2, runs each energy-aware test problem through the ROS 2 services,
...
def main():
    print("=" * 60)
    print("Exercise 9.2 — PlanSys2 Integration Tests")
